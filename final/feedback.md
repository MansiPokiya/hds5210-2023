...
**(-1) Merging (joining) on a column that isn't unique ends up applything the rows from one side of the joint to multiple rows on the other side.  It ends up duplicating rows.**

**(-3) Looks like there is only one merge/join here.  Full credit required two of these.**

**Overall, you did some great work on this final project!  Nice job.**