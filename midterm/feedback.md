...
* **5pts** - Your code correctly fetched the JSON file, parsed it, and looked up the hospital
  * **(-1 pts) Your code references `req.get()` which I think was supposed to be `requests.get*()`?**
* **2pts** - You had a docstring that described what the function was for
* **3pts** - You had at least three doctests in your docstring
...
* **(-1 pts) You submitted code that hadn't been run successfully end-to-end.  Typos like `req.get()` made it clear your work was not fully tested**